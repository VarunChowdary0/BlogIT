...
export default function Profile() {
   const {hostname} = useContext(Globals)
    ...
    const [AllPostsRaw  , UpdateAllPosts ] = useState(JSON.parse(localStorage.getItem("PostIdArray"))||[]);
            ...
            :<div className="inner_Middle">
                ...
                <div className="test_ii profile_block">
                        ...
                        <div className="add_info_block">
                            <div className="info_add_butt" onClick={()=>openEditorPopUp()}>Add</div>
                            <div className="info_add_butt" onClick={()=>openEditorPopUp()}>Edit</div>
                        </div>
                            ...
                            {UserArray.map((ele, index) => {
                                if (ele['username'] !== username && followers.find(item => item === ele['uniqueID']) !== undefined) {
                                    ...
                                    <div className="frnd_121"  onClick={()=>{seeUser(ele['uniqueID'])}}>
                                        ...
                                        <div className="follow_icn"onClick={()=>{seeUser(ele['uniqueID'])}}>view</div>
                                    </li>
                                    );
                                }
                                return null;
